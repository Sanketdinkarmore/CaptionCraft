...
const features = [
  "Hindi • Marathi • Hinglish • English",
  "Smart Sync",
  "Custom Fonts",
  "Fast Export",
  "SRT Support",
...
const MarqueeStrip = () => {
  return (
    <div className="w-full overflow-hidden relative py-5 md:py-6 -mt-px">
      ...
      <div className="absolute inset-0 bg-linear-to-r from-background via-primary/8 to-background" />
      
      {/* Animated gradient overlay for shimmer effect */}
      <div className="absolute inset-0 bg-linear-to-r from-transparent via-primary/5 to-transparent animate-pulse opacity-50" />
      ...
      >
        ...
        {features.map((feature, index) => (
          ...
          >
            ...
            <div className="absolute inset-0 -z-10 rounded-lg bg-linear-to-r from-primary/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
          </div>
        ))}
